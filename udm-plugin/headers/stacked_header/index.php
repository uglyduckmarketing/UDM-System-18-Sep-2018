						   ...
						   <?php 
								...
								<div class="col">
									<ul class="top_header_get_bt top_header_get_bt_show middletopbutton">
										<li><span class="right_side_bt"><a href="<?php if($url!=""){ echo isset($url) ? $url : '';; }else{ echo "#"; } ?>"><button type="button" class="btn"><h6><?php if(isset($data['middletopbar_button_text']) && $data['middletopbar_button_text']!=""){ echo esc_attr($data['middletopbar_button_text']); }else{ ?>Get Started<?php } ?></h6><i class="fa fa-arrow-right" aria-hidden="true"></i></button></a></span></li>
										</ul>
								</div>
								<?php 
									}
