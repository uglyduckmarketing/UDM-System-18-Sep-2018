    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col col-lg-6 p1-left align-self-stretch <?php if($datas['cta_choose_button_form'] == 'form'){ echo "form_text"; } else if($data['element_type']=="form"){ echo "form_text"; }else if($data['element_type']=="image"){ echo "mobbackimage"; } ?>">
				...
				?>
                <span class="right_side_bt"><a <?php if(isset($url) && $url!=""){ ?> target="_blank" <?php } ?> class="btn custbtn" href="<?php if($url!=""){ echo isset($url) ? $url : '';}else{ ?>#<?php } ?>"><?php echo esc_attr($button); ?><i class="fa fa-arrow-right" aria-hidden="true"></i></a></span>
				<?php } ?>
                </div>
            </div>
