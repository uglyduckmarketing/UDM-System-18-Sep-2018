...
<script>
	jQuery(document).ready(function($) {
	   ...
	   $('#blog_layout_template').change(function(){ //Edit saved blog layout
			var blog = $(this).val();
			if(blog == '1')
			{
				jQuery.ajax({
					type: 'get',
					url: "<?php echo get_template_directory_uri(); ?>/udm-plugin/admin/blog/templates/grid.php",
					beforeSend: function(){
						 $(".preloader").show();
					   },
					   complete: function(){
			...
			else if(blog == '2')
			{
				jQuery.ajax({
					type: 'get',
					url: "<?php echo get_template_directory_uri(); ?>/udm-plugin/admin/blog/templates/cards.php",
					beforeSend: function(){
						 $(".preloader").show();
					   },
					   complete: function(){
