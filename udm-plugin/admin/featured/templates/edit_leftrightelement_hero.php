...
<ul id="editlayoutsettings" class="hero_type_style collapse show leftrighthero common_setting">
	...
	<div id="editcallactionwidget" class="common_setting" <?php if($data['show_button']!="yes"){ ?> style="display:none;" <?php } ?>>
