...
<ul id="editlayoutsettings" class="hero_type_style collapse show leadgen_hero">
	...
	<li><h3>Form Shortcode: </h3><input type="text" name="form_shortcode" value="<?php echo $data['form_shortcode']; ?>" /></li>
	<li>
		<h3>Button:</h3>
		<span class="switch">
