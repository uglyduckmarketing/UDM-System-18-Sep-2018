...
$data=unserialize(get_option('header_layout_'.$headertype));
?>
	...
	jQuery(document).ready(function($) {
			...
			?>
					jQuery.ajax({
					type: 'post',
					data:'location=lefttopbar&header=<?php echo $headertype; ?>',
			...
			?>
					jQuery.ajax({
					type: 'post',
					data:'location=righttopbar&header=<?php echo $headertype; ?>',
					url: "<?php echo get_template_directory_uri(); ?>/udm-plugin/admin/headers/templates/widgets/text.php",
					beforeSend: function(){
						 $(".preloader").show();
					   },
