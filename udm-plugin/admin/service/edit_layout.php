...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div id="editselected_layout">
		...
		<div class="cus_grid_style">
			<ul id="editdescsettings" class="hero_type_style collapse show basic_hero common_setting">
			...
			<ul id="editbenefitssettings" class="hero_type_style collapse show basic_hero common_setting">
			...
			<ul id="editbreakdownsettings" class="hero_type_style collapse show basic_hero common_setting">
				<li class="colorchange"><h4>Description Eyebrow Color: </h4>
			...
			<ul id="servicectasettings" class="hero_type_style collapse show basic_hero common_setting">
				...
				<li class="show_button_f custom_btn_style" <?php if($choose_btn_form == 'form'){ echo 'style="display:none;"'; } ?>>
					<div class="own_fields own_input_field_text"><h4>Button Text</h4><input type="text" class="" name="cta_button_text" value="<?php echo esc_attr($data['cta_button_text']); ?>" />
					<div class="clearfix"></div>
					</div>
					<div class="own_fields own_input_field_text"><h4>Button Link</h4><input type="text" class="" name="cta_button_link" value="<?php echo esc_attr($data['cta_button_link']); ?>" />
					<div class="clearfix"></div>
					</div>
			...
			<ul id="relatedsettings" class="hero_type_style collapse show basic_hero common_setting">
				...
				<li><h4>Description:</h4>
					<div class="own_fields own_input_field_text">
						<textarea rows="5" name="related_description"><?php  echo isset($data['related_description']) ? $data['related_description'] : '';  ?></textarea>
						<div class="clearfix"></div>
					</div>
				</li> 
				<li>
				<?php  $show_related = isset($data['show_related']) ? $data['show_related'] : '';  ?>
					<h4>Show Related: </h4>  
					<div class="own_fields own_input_field_text cus_own_field">
