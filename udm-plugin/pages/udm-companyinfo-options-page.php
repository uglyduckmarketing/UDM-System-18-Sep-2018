...
<div class="wrap udm-opt">
	...
	?>
		<ul class="base-setings company" aria-multiselectable="true">
            <li>
                <ul class="inner">
                    <li class="imageupload"><h4>Company Logo</h4><input type="text" name="udm_company_logo" id="udm_company_logo" class="meta-image regular-text main-image" value="<?php echo get_option('udm_company_logo'); ?>"><input class="btn upload-image" my-attr="main-image" type="button" value="Upload Image" /></li>
