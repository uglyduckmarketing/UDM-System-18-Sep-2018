		...
		<div class="container">
			<div class="row editsection">
				<div class="col-md-12">
					...
					?>
						<option value="<?php echo str_replace("footer_cta_layout_","",$layout); ?>" <?php selected($prevlayout,str_replace("footer_cta_layout_","",$layout)); ?> <?php if(get_option('udm_footer_cta_default')==str_replace("footer_cta_layout_","",$layout)){ echo ' class="selectedlayout"'; } ?>><?php echo str_replace("_"," ", str_replace("footer_cta_layout_","",$layout)); ?></option>
					<?php	
