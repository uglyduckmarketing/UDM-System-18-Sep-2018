		...
		<div class="container">
			<div class="row editsection">
				<div class="col-md-12">
					...
					?>
						<option value="<?php echo str_replace("featured_layout_","",$layout); ?>" <?php if(get_option('udm_hero_default')==str_replace("featured_layout_","",$layout)){ echo ' class="selectedlayout"'; } ?>><?php echo str_replace("_"," ", str_replace("featured_layout_","",$layout)); ?></option>
					<?php	
