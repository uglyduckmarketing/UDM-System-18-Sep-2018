		...
		<ul class="base-setings common_setting" aria-multiselectable="true">
            <li>
                <ul class="inner">
					...
					<li><h4>Select Default Service CTA: </h4>
						<select name="udm_service_cta_default">
							<option value="">Select Layout</option>	
								<?php  
									global $wpdb;
									...
									foreach($layouts as $layout){
								?>
									<option value="<?php echo str_replace("service_cta_layout_","",$layout); ?>" <?php selected(str_replace("service_cta_layout_","",$layout),get_option('udm_service_cta_default')); ?>><?php echo str_replace("_"," ", str_replace("service_cta_layout_","",$layout)); ?></option>
								<?php	
									}
								?>
						</select>
