...
<div class="wrap udm-opt mobile_header_layouts">
			...
			<div class="row editsection">
				<div class="col-md-12">
					<select name="editsavedlayout" id="editsavedlayout">
						...
						?>
							<option value="<?php echo str_replace("mobile_header_layout_","",$layout); ?>" <?php if(get_option('udm_mobile_header_default')==str_replace("mobile_header_layout_","",$layout)){ echo ' class="selectedlayout"'; } ?>><?php echo str_replace("_"," ", str_replace("mobile_header_layout_","",$layout)); ?></option>
						<?php	
