...
<script>
    ...
    $(document).ready(function(){  //Basic Overlay navigation script
		...
		?>
		$(document).ready(function(){  //Basic Slidedown navigation script
		...
		(function ($) {   //Slide In navigation script 
			...
			$(".menu-button").click(function(){
				 $(".menu-button").toggleClass("close-menu menu-button-open");
				if($('#mobile-slide-in').attr('style')=='left: 0px; right: auto; transform: translateX(-100%); display: block;')
				{
