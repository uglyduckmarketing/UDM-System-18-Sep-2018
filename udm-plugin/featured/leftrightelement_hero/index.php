...
?>
<section class="fullwidth-hero-3 leadgen-hero left-right_hero">
    <div class="container">
        <div class="row <?php if($data['content_side']=="right"){ echo "content-right"; } ?>">
            <div class="col col-md-6">
                <div class="fullwidth_content">
                    <?php if (is_array($meta) && isset($meta['udm_leftrightelement_eyebrow_text_show']) && $meta['udm_leftrightelement_eyebrow_text_show']=="yes") { ?> <span><?php if (is_array($meta) && $meta['udm_leftrightelement_eyebrow_text']!="") {	echo esc_attr($meta['udm_leftrightelement_eyebrow_text']); } ?></span><?php } ?>
                    <h2><?php if (is_array($meta) && $meta['udm_leftrightelement_header_text']!="") {	echo esc_attr($meta['udm_leftrightelement_header_text']); }else{ the_title(); } ?></h2>
                    <p><?php if (is_array($meta) && $meta['udm_leftrightelement_description']!="") {	echo esc_attr($meta['udm_leftrightelement_description']); }else{ ?>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.<?php } ?></p>
                </div>
            ...
            <div class="col col-md-6">
                <div class="form_part_top">
					...
					?>
						<iframe width="450" height="315" src="<?php echo esc_attr($embedurl); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>

					<?php } ?>
				 <?php if(is_array($meta) && $meta['udm_leftrightelement_element']=="image"){ ?><img width="450" height="315" src="<?php if (is_array($meta) && $meta['udm_leftrightelement_image']!="") {	echo esc_attr($meta['udm_leftrightelement_image']); } ?>" ><?php } ?>
                </div>
            </div>
