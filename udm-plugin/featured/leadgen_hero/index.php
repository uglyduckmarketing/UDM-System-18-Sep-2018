        ...
        <div class="row">
            <div class="col col-md-6">
                <div class="fullwidth_content">
                   <?php if (is_array($meta) && $meta['udm_leadgen_eyebrow_text_show']=="no") {}else{ ?> <span><?php if (is_array($meta) && $meta['udm_leadgen_eyebrow_text']!="") {	echo $meta['udm_leadgen_eyebrow_text']; } ?></span><?php } ?>
