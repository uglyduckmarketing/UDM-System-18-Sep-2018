...
class UDM_CTA extends WP_Widget{
  ...
  <p>
  	<label for="<?php echo $this->get_field_id('title'); ?>">Header:
    ...
    <label for="<?php echo $this->get_field_id('call_to_action_overlay'); ?>">Overlay Opacity (0.1 - 1):
  		<input class="widefat" id="<?php echo $this->get_field_id('call_to_action_overlay'); ?>" name="<?php echo $this->get_field_name('call_to_action_overlay'); ?>" type="text" value="<?php echo attribute_escape($call_to_action_overlay); ?>" />
    </label>
  </p>
    ...
    // Header Title
      ...
      echo $args['before_title'] . "<h2>{$instance['title']}</h2>". $args['after_title'];
    };
    // Widget Content
