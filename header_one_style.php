<?php 
	...
	a{
		color:<?php echo $udm_primary_color; ?>;
	}
	a:hover{
		color:<?php echo $udm_secondary_color; ?>;
	} 
	.primary{
		background: <?php echo $udm_primary_color; ?>;
	}
	...
	header.header_mrappliance{
		background:<?php echo ($header_background!="" ? $header_background : "#fff"); ?>;
	}
	
	header.header_mrappliance .top-navbar-section{
		background:<?php echo ($top_bar_background!="" ? $top_bar_background : "#fff"); ?>;
	}
	header.header_mrappliance .bottom-navbar-section{
		background:<?php echo ($bottom_nav_background!="" ? $bottom_nav_background : "#fff"); ?>;
	}
	header.header_mrappliance .bottom-navbar-section ul li a {
	  color: <?php echo $bottom_nav_link_color; ?>;
	  font-size: <?php echo ($udm_bottom_nav_fontsize!="" ? $udm_bottom_nav_fontsize : "18"); ?>px;
	}
	
	header.header_mrappliance .bottom-navbar-section ul li ul {
	  background: <?php echo $nav_dropdown_background; ?>;
	}
	
	header.header_mrappliance .bottom-navbar-section ul li ul li a {
		color: <?php echo $bottom_nav_dropdown_link_color; ?>;
		font-size: <?php echo ($udm_bottom_nav_fontsize!="" ? $udm_bottom_nav_fontsize : "18"); ?>px;
	}
	...
	header.header_mrappliance .bottom-navbar-section ul li.current-menu-item a::before {
		background: <?php echo $udm_secondary_color; ?>;
		width: 100%;
	}
	
	header.header_mrappliance .logo-container .header-logo{
		background:<?php echo $udm_logo_background; ?>;
		width:<?php echo $udm_logo_default; ?>px;
		max-width:<?php echo $udm_logo_default; ?>px;
	}
	
	
	@media(max-width: 767px) {
		header.header_mrappliance .btn {
		  box-shadow: 0px 0px 0px 3px <?php echo $udm_secondary_color; ?>35;
		}
		header.header_mrappliance .btn:hover {
			box-shadow: 0px 0px 0px 4px <?php echo $udm_secondary_color; ?>45;
		}
	}
	
	header.mobile-menu .menu_bar_custom{
		background:<?php echo ($udm_mobile_header_nav_background!="" ? $udm_mobile_header_nav_background : "#fff"); ?>;
	}
	
	header.mobile-menu .menu_bar_custom .mob-no-menu p, header.mobile-menu .menu_bar_custom .mob-no-menu a{
		color:<?php echo ($udm_mobile_top_text_color!="" ? $udm_mobile_top_text_color : "#000"); ?>
	}
	
	header.mobile-menu .menu_bar_custom .dl-menuwrapper ul {
		background-color: <?php echo ($udm_mobile_nav_backgroud!="" ? $udm_mobile_nav_backgroud : "#fff"); ?>;
	}
	header.mobile-menu .menu_bar_custom .dl-menuwrapper li a {
		color: <?php echo ($udm_mobile_nav_link_color!="" ? $udm_mobile_nav_link_color : "#333"); ?>;
	}
	
	header.mobile-menu .menu_bar_custom .dl-menuwrapper li a:hover {
		color: <?php echo ($udm_mobile_nav_link_hover_color!="" ? $udm_mobile_nav_link_hover_color : "#eeee22"); ?>;
	}
